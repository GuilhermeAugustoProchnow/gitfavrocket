import { GithubUser } from "./GithunUser.js"
...
export class FavoritesView extends Favorites {
    ...
    creatRow() {
        ...
        <td class="user">
              <img
                src="https://github.com/GuilhermeAugustoProchnow.png"
                alt="Imagem Guilherme "
              />
              <a
                href="https://github.com/GuilhermeAugustoProchnow"
                target="_blank"
              >
                <p>Guilherme</p>
                <span>GuilhermeAugustoProchnow</span>
              </a>
            </td>
